...
## 3.1 Enhanced Configuration Access Mechanism | 3.1 增强型配置访问机制
...
## 3.4 Configuration Requests | 3.4 配置请求
...
## 3.5 Type 0 Configuration Request | 3.5 Type 0 配置请求
...
## 3.6 Type 1 Configuration Request | 3.6 Type 1 配置请求
...
## 3.7 Example PCI-Compatible Configuration Access | 3.7 PCI兼容配置访问示例
...
## 3.8 Example Enhanced Configuration Access | 3.8 增强型配置访问示例
...
## 3.9 Enumeration - Discovering the Topology | 3.9 枚举——发现拓扑结构
...
## 3.10 Discovering the Presence or Absence of a Function | 3.10 发现功能的存在或缺失
...
## 3.11 Device not Present | 3.11 设备不存在
...
## 3.12 Device not Ready | 3.12 设备未就绪
...
## 3.13 Determining if a Function is an Endpoint or Bridge | 3.13 确定一个功能是端点还是桥
...
## 3.14 Single Root Enumeration Example | 3.14 单根枚举示例
...
## 3.15 PCI Express Technology | 3.15 PCI Express 技术
...
## 3.16 Multi-Root Enumeration Example | 3.16 多根枚举示例

## 3.17 General | 3.17 概述
...
## 3.18 Multi-Root Enumeration Process | 3.18 多根枚举过程
...
## 3.19 Hot-Plug Considerations | 3.19 热插拔考虑因素
...
## 3.21 MindShare Arbor Feature List | 3.21 MindShare Arbor 功能列表
...
## 3.22 PCI Express Technology | 3.22 PCI Express 技术
...
## 3.23 Configuration Space | 3.23 配置空间
