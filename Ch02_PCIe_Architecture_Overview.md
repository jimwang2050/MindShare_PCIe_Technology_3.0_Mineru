...
## 2.2 PCI Express Technology | 2.2 PCI Express 技术
...
## 2.3 Software Backward Compatibility | 2.3 软件向后兼容性
...
## 2.4 The Need for Speed | 2.4 速度需求
...
## 2.5 PCI Express Technology | 2.5 PCI Express 技术
...
## 2.6 PCIe Bandwidth Calculation | 2.6 PCIe 带宽计算
...
## 2.7 PCI Express Technology | 2.7 PCI Express 技术
...
## 2.8 Differential Signals | 2.8 差分信号
...
## 2.9 No Common Clock | 2.9 无需公共时钟
...
## 2.10 Packet-based Protocol | 2.10 基于数据包的协议
...
## 2.11 Links and Lanes | 2.11 链路与通道
...
## 2.12 Scalable Performance | 2.12 可扩展性能
...
## 2.13 Some Definitions | 2.13 一些定义
...
## 2.14 Topology Characteristics | 2.14 拓扑特性
...
## 2.16 Switches and Bridges | 2.16 交换机与桥
...
## 2.17 Native PCIe Endpoints and Legacy PCIe Endpoints | 2.17 原生PCIe端点与传统PCIe端点
...
## 2.18 Software Compatibility Characteristics | 2.18 软件兼容性特性
...
## 2.19 System Examples | 2.19 系统示例
...
## 2.20 Introduction to Device Layers | 2.20 设备层介绍
...
## 2.21 Device Core / Software Layer | 2.21 设备核心 / 软件层
...
## 2.22 Transaction Layer | 2.22 事务层
...
## 2.23 TLP (Transaction Layer Packet) Basics | 2.23 TLP（事务层包）基础
...
## 2.24 Non-Posted Transactions | 2.24 非转发事务
...
## 2.25 Posted Writes | 2.25 Posted写操作
...
## 2.26 Quality of Service (QoS) | 2.26 服务质量 (QoS)
...
## 2.27 Transaction Ordering | 2.27 事务排序
...
## 2.29 Data Link Layer | 2.29 数据链路层
...
## 2.30 DLLPs (Data Link Layer Packets) | 2.30 DLLP (数据链路层包)
...
## 2.32 Power Management | 2.32 电源管理
...
## 2.33 Physical Layer | 2.33 物理层

## 2.34 General | 2.34 概述
...
## 2.35 Link Training and Initialization | 2.35 链路训练与初始化
...
## 2.37 Protocol Review Example | 2.37 协议回顾示例
...
## 2.38 Memory Read Request | 2.38 存储器读请求
...
## 2.39 PCI Express Technology | 2.39 PCI Express 技术
...
## 2.40 Completion with Data | 2.40 带数据的完成报文
...
## 2.41 Definition of Bus, Device and Function | 2.41 总线、设备与功能的定义
...
## 2.43 PCIe Devices | 2.43 PCIe 设备
...
## 2.44 PCIe Functions | 2.44 PCIe 功能
...
## 2.45 Configuration Address Space | 2.45 配置地址空间
...
## 2.46 Extended Configuration Space | 2.46 扩展配置空间
...
## 2.48 Only the Root Sends Configuration Requests | 2.48 仅根复合体发送配置请求
...
## 2.49 Legacy PCI Mechanism | 2.49 传统PCI机制
...
## 2.50 Configuration Address Port | 2.50 配置地址端口
...
## 2.51 Bus Compare and Data Port Usage | 2.51 总线比较与数据端口使用
...
## 2.52 Single Host System | 2.52 单主机系统
