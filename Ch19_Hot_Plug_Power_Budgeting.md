...
## 19.1 Intelligent Adapters | 19.1 智能适配器
...
## 19.2 Host Failover | 19.2 主机故障切换
...
## 19.3 Multiprocessor Systems | 19.3 多处理器系统
...
## 19.4 The History Multi-Processor Implementations Using PCI | 19.4 使用 PCI 的多处理器实现历史
...
## 19.5 Implementing Multi-host | 19.5 Intelligent Adapters in PCI Express Base Systems / 在 PCI Express 基础系统中实现多主机/智能适配器
...
## 19.6 Example: Implementing Intelligent Adapters in a PCI Express Base System | 19.6 示例：在 PCI Express 基础系统中实现智能适配器
## 19.7 示例：在 PCI Express 基础系统中实现智能适配器
...
## 19.8 Example: Implementing Host Failover in a PCI Express System | 19.8 示例：在 PCI Express 系统中实现主机故障切换
## 19.9 示例：在PCI Express系统中实现主机故障切换
...
## 19.10 PCI Express 3.0 Technology | 19.10 PCI Express 3.0 技术
...
## 19.12 Address Translation | 19.12 地址翻译
...
## 19.13 Direct Address Translation | 19.13 直接地址翻译
...
## 19.14 Lookup Table Based Address Translation | 19.14 基于查找表的地址转换
...
## 19.15 Downstream BAR Limit Registers | 19.15 下游BAR限制寄存器
...
## 19.16 Forwarding 64bit Address Memory Transactions | 19.16 转发64位地址存储器事务
...
## 19.19 PCI Express Technology | 19.19 PCI Express技术
...
## 19.20 The PCI Express Lock Protocol | 19.20 PCI Express锁定协议
...
## 19.21 Lock Messages — The Virtual Lock Signal | 19.21 锁定消息——虚拟锁定信号
...
## 19.22 The Lock Protocol Sequence — an Example | 19.22 锁定协议序列——示例
...
## 19.23 The Memory Read Lock Operation | 19.23 存储器读锁定操作
...
## 19.24 Read Data Modified and Written to Target and Lock Completes | 19.24 读数据被修改并写入目标，锁定完成
...
## 19.25 Notification of an Unsuccessful Lock | 19.25 不成功锁定的通知
...
## 19.26 Summary of Locking Rules | 19.26 锁定规则总结
...
## 19.27 Rules Related To the Initiation and Propagation of Locked Transactions | 19.27 与锁定事务发起和传播相关的规则
...
## 19.28 Rules Related to Switches | 19.28 与交换机相关的规则
...
## 19.29 Rules Related To PCI Express/PCI Bridges | 19.29 与PCI Express/PCI桥相关的规则
...
## 19.30 Rules Related To the Root Complex | 19.30 与根复合体相关的规则
...
## 19.31 Rules Related To Legacy Endpoints | 19.31 与遗留端点相关的规则
...
## 19.32 Rules Related To PCI Express Endpoints | 19.32 与PCI Express端点相关的规则
...
## 19.33 Locked Transactions | 19.33 锁定事务

## 19.34 Introduction | 19.34 引言
...
## 19.36 PCI Express Technology | 19.36 PCI Express 技术
...
## 19.37 The PCI Express Lock Protocol | 19.37 PCIe 锁定协议
...
## 19.38 Lock Messages — The Virtual Lock Signal | 19.38 锁消息 — 虚拟锁定信号
...
## 19.39 The Lock Protocol Sequence — an Example | 19.39 锁协议序列示例
...
## 19.40 The Memory Read Lock Operation | 19.40 存储器读锁定操作
...
## 19.41 PCI Express Technology | 19.41 PCI Express技术
...
## 19.42 Read Data Modified and Written to Target and Lock Completes | 19.42 读取数据修改后写入目标并完成锁定
...
## 19.43 PCI Express Technology | 19.43 PCI Express技术
...
## 19.44 Notification of an Unsuccessful Lock | 19.44 锁定失败通知
...
## 19.45 Summary of Locking Rules | 19.45 锁定规则总结
...
## 19.46 Rules Related To the Initiation and Propagation of Locked Transactions | 19.46 锁定事务的发起与传播相关规则
...
## 19.47 Rules Related to Switches | 19.47 与交换机相关的规则
...
## 19.48 Rules Related To PCI Express/PCI Bridges | 19.48 PCI Express/PCI 桥相关规则
...
## 19.49 Rules Related To the Root Complex | 19.49 与根复合体相关的规则
...
## 19.50 Rules Related To Legacy Endpoints | 19.50 与传统端点相关的规则
