...
<table style="border-collapse:collapse;width:100%">
  <tbody>
      <tr><td width="50%" style="border:1px solid #333;background:#fff;padding:4px 8px;">Table 13-2: Tx Coefficient Table</td><td width="50%" style="border:1px solid #333;background-color:#e8e8e8;padding:4px 8px;">表 13-2：发送器系数表</td></tr>
  </tbody>
</table>
...
<tr><td width="50%" style="border:1px solid #333;background:#fff;padding:4px 8px;">Table 13‐5: Common Receiver Characteristics</td><td width="50%" style="border:1px solid #333;background-color:#e8e8e8;padding:4px 8px;">表13‐5：通用接收器特性</td></tr>
