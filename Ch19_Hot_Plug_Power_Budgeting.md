...
## Direct Address Translation | 直接地址翻译
...
## The PCI Express Lock Protocol | PCI Express锁定协议
...
## Summary of Locking Rules | 锁定规则总结
...
## Rules Related To the Initiation and Propagation of Locked Transactions | 与锁定事务发起和传播相关的规则
...
## Rules Related to Switches | 与交换机相关的规则
...
## Rules Related To PCI Express/PCI Bridges | 与PCI Express/PCI桥相关的规则
...
## Rules Related To the Root Complex | 与根复合体相关的规则
...
## Rules Related To Legacy Endpoints | 与遗留端点相关的规则
...
## Rules Related To PCI Express Endpoints | 与PCI Express端点相关的规则
...
## The PCI Express Lock Protocol | PCIe 锁定协议
...
## Rules Related To the Initiation and Propagation of Locked Transactions | 锁定事务的发起与传播相关规则
...
## Rules Related To PCI Express/PCI Bridges | PCI Express/PCI 桥相关规则
...
## Rules Related To Legacy Endpoints | 与传统端点相关的规则
