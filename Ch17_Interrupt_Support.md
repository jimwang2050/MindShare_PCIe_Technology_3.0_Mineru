...
## 17.3 Pausing a Driver (Optional) | 17.3 暂停驱动（可选）
...
## 17.4 Quiescing a Driver That Controls Multiple Devices | 17.4 暂停控制多个设备的驱动
...
## 17.5 Quiescing a Failed Card | 17.5 暂停故障卡
## 17.6 Quiescing a Failed Card | 17.6 使故障卡静止（Quiescing）
...
## 17.8 Introduction to Power Budgeting | 17.8 电源预算简介
...
## 17.9 The Power Budgeting Elements | 17.9 功率预算要素
...
## 17.10 The Power Budget Manager | 17.10 功率预算管理器
...
## 17.11 Expansion Ports | 17.11 扩展端口
...
## 17.12 Spec requirements: | 17.12 规范要求：
## 17.13 规范要求：
...
## 17.14 Add-in Devices | 17.14 插件设备
...
## 17.15 Slot Power Limit Control | 17.15 插槽功率限制控制
...
## 17.16 Expansion Device Limits Power Consumption | 17.16 扩展设备限制功耗
...
## 17.17 The Power Budget Capabilities Register Set | 17.17 功率预算能力寄存器集
...
## 17.18 Changes for PCIe Spec Rev 2.1 | 17.18 PCIe 规范 Rev 2.1 的变更
...
## 17.19 System Redundancy Improvement: Multi-casting | 17.19 系统冗余改进：多播
...
## 17.20 Multicast Capability | 17.20 多播能力
...
## 17.21 Multicast Control | 17.21 多播控制
...
## 17.23 MC Block All | 17.23 MC 全部阻止
...
## 17.24 MC Block Untranslated | 17.24 MC 阻止未翻译
...
## 17.25 Multicast Example | 17.25 多播示例
...
## 17.26 MC Overlay BAR | 17.26 MC 覆盖 BAR
...
## 17.27 Overlay Example | 17.27 覆盖示例
...
## 17.28 Routing Multicast TLPs | 17.28 路由多播TLP
...
## 17.29 Congestion Avoidance | 17.29 拥塞避免
...
## 17.30 Performance Improvements | 17.30 性能改进
...
## 17.31 TPH (TLP Processing Hints) | 17.31 TPH（TLP 处理提示）
...
## 17.32 TPH Examples | 17.32 TPH示例
...
## 17.33 TPH Header Bits | 17.33 TPH头部比特位
...
## 17.34 Steering Tags | 17.34 导向标签
...
## 17.35 PCI Express Technology | 17.35 PCI Express 技术
...
## 17.36 TLP Prefixes | 17.36 TLP前缀
...
## 17.37 IDO (ID-based Ordering) | 17.37 IDO（基于 ID 的排序）
...
## 17.38 ARI (Alternative Routing-ID Interpretation) | 17.38 ARI（替代路由ID解读）
...
## 17.39 Power Management Improvements | 17.39 电源管理改进
...
## 17.40 DPA (Dynamic Power Allocation) | 17.40 DPA（动态功率分配）
...
## 17.41 OBFF (Optimized Buffer Flush and Fill) | 17.41 OBFF（优化缓冲区刷新与填充）
...
## 17.42 ASPM Options | 17.42 ASPM 选项
