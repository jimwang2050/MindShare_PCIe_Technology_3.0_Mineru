...
## 6.3 Flow Control Credits | 6.3 流控信用量
...
## 6.4 Initial Flow Control Advertisement | 6.4 初始流控通告
...
## 6.5 Minimum and Maximum Flow Control Advertisement | 6.5 最小和最大流控通告
...
## 6.6 Flow Control Initialization | 6.6 流控初始化
...
## 6.8 The FC Initialization Sequence | 6.8 FC 初始化序列
...
## 6.9 FC_Init2 Details | 6.9 FC_Init2 详情
...
## 6.10 Introduction to the Flow Control Mechanism | 6.10 流控机制简介

## 6.11 General | 6.11 概述
...
## 6.12 The Flow Control Elements | 6.12 流控元素
...
## 6.13 Receiver Elements | 6.13 接收器要素
...
## 6.14 Stage 2 — Flow Control Buffer Fills Up | 6.14 阶段2 — 流控缓冲器填满
...
## 6.15 Stage 3 — Counters Roll Over | 6.15 阶段3 — 计数器回绕
...
## 6.16 Flow Control Updates | 6.16 流控更新
