...
## 8.3 PCI Express 3.0 Technology | 8.3 PCI Express 3.0 技术
...
## 8.5 Ordering Rules and Traffic Classes (TCs) | 8.5 排序规则和流量类别（TC）
...
## 8.6 Ordering Rules Based On Packet Type | 8.6 基于数据包类型的排序规则
...
## 8.7 The Simplified Ordering Rules Table | 8.7 简化排序规则表
...
## 8.8 生产者 | 8.8 消费者模型 (Producer/Consumer Model)
...
## 8.9 Producer | 8.9 Consumer Sequence — No Errors
...
## 8.10 Producer/Consumer Sequence — No Errors | 8.10 生产者/消费者序列 — 无错误
...
## 8.11 Producer/Consumer Sequence — Errors | 8.11 ## 生产者/消费者序列——错误
...
## 8.12 Relaxed Ordering | 8.12 宽松排序
...
## 8.13 RO Effects on Memory Read Transactions | 8.13 RO对存储器读事务的影响
...
## 8.15 Transaction Stalls | 8.15 事务阻塞
...
## 8.16 VC Buffers Offer an Advantage | 8.16 VC 缓冲器的优势
...
## 8.18 When to use IDO | 8.18 何时使用 IDO
...
## 8.19 Software Control | 8.19 软件控制
...
## 8.20 Deadlock Avoidance | 8.20 死锁避免
