...
## 10.2 Elements of the Ack | 10.2 Nak Protocol
...
## 10.3 Transmitter Elements | 10.3 发送器要素
...
## 10.4 NEXT_TRANSMIT_SEQ Counter | 10.4 NEXT_TRANSMIT_SEQ 计数器
...
## 10.5 LCRC Generator | 10.5 LCRC 生成器
...
## 10.6 REPLAY_TIMER Count | 10.6 重发定时器计数
...
## 10.8 DLLP CRC Check | 10.8 DLLP CRC 检查
...
## 10.9 LCRC Error Check | 10.9 LCRC 错误检查
...
## 10.10 Sequence Number Check | 10.10 序列号检查
...
## 10.13 Ack | 10.13 Nak Protocol Details
...
## 10.14 Sequence Number | 10.14 序列号
...
## 10.15 Replay (Retry) Buffer | 10.15 重放（重试）缓冲区
...
## 10.16 Transmitter's Response to an Ack DLLP | 10.16 发送器对 Ack DLLP 的响应
...
## 10.19 Transmitter's Response to a Nak | 10.19 发送方对 Nak 的响应
...
## 10.20 Efficient TLP Replay | 10.20 高效的TLP重放
...
## 10.21 Transmitter DLLP Handling | 10.21 发送器 DLLP 处理
...
## 10.22 TLP LCRC Check | 10.22 TLP LCRC 检查
...
## 10.23 Next Received TLP's Sequence Number | 10.23 下一个接收TLP的序列号
...
## 10.24 Receiver Schedules An Ack DLLP | 10.24 接收方调度Ack DLLP
...
## 10.25 Receiver Schedules a Nak | 10.25 接收端调度 Nak
...
## 10.26 AckNak_LATENCY_TIMER | 10.26 AckNak_LATENCY_TIMER
...
## 10.27 AckNak\_LATENCY\_TIMER Equation.
...
## 10.30 Error Situations Handled by Ack | 10.30 Nak

## 10.31 Ack/Nak 协议处理的错误情况
...
## 10.32 Recommended Priority To Schedule Packets | 10.32 推荐的数据包调度优先级
...
## 10.33 Timing Differences for Newer Spec Versions | 10.33 较新规范版本的时序差异
...
## 10.36 Replay Timer | 10.36 重放定时器
...
## 10.37 Switch Cut-Through Mode | 10.37 交换机关发直通模式
...
## 10.38 A Latency Improvement Option | 10.38 延迟改善选项
...
## 10.39 Cut-Through Operation | 10.39 直通模式操作
...
## 10.40 Example of Cut-Through Operation | 10.40 直通模式操作示例

## 10.41 Example of Cut-Through Operation | 10.41 直通模式操作示例
...
## 10.42 Physical Layer Overview | 10.42 物理层概述
