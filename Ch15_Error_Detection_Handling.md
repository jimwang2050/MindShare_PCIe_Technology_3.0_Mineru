...
## 15.1 D2 State—Deep Sleep | 15.1 D2 状态—深度休眠
...
## 15.2 PCI Express Technology | 15.2 PCI Express 技术
...
## 15.3 Other characteristics of the D2 state include: | 15.3 D2 状态的其他特性包括：
...
## 15.4 PCI Express Technology | 15.4 PCI Express 技术
...
## 15.5 PM Control and Status Register (PMCSR) | 15.5 电源管理控制和状态寄存器（PMCSR）
...
## 15.6 PCI Express Technology | 15.6 PCI Express 技术
...
## 15.7 PCI Express Technology | 15.7 PCI Express 技术
...
## 15.8 Introduction to Link Power Management | 15.8 链路电源管理简介
## 15.9 Introduction to Link Power Management | 15.9 链路电源管理简介
...
## 15.10 Active State Power Management (ASPM) | 15.10 主动状态电源管理（ASPM）
## 15.11 Active State Power Management (ASPM) | 15.11 主动状态电源管理(ASPM)
...
## 15.12 Electrical Idle | 15.12 电气空闲
...
## 15.13 Transmitter Entry to Electrical Idle | 15.13 发送器进入电气空闲
...
## 15.14 Transmitter Exit from Electrical Idle | 15.14 发送器退出电气空闲
...
## 15.15 PCI Express Technology | 15.15 PCI Express 技术
...
## 15.16 Receiver Entry to Electrical Idle | 15.16 接收器进入电气空闲
...
## 15.17 Receiver Exit from Electrical Idle | 15.17 接收器退出电气空闲
...
## 15.21 Exit from L0s State | 15.21 退出 L0s 状态
...
## 15.22 Downstream Component Decides to Enter L1 ASPM | 15.22 下游组件决定进入 L1 ASPM
...
## 15.23 Scenario 1: Both Ports Ready to Enter L1 ASPM State | 15.23 场景 1：两端端口均准备好进入 L1 ASPM 状态
...
## 15.24 Upstream Component Response to L1 ASPM Request. Downstream ports (i.e., ports of an upstream component that face downward) must accept a request to enter a low power L1 state if all of the following conditions are true:
...
## 15.25 Scenario 3: Downstream Component Receives TLP During Negotiation | 15.25 场景 3：下游组件在协商期间接收 TLP
...
## 15.26 Scenario 4: Upstream Component Receives TLP During Negotiation | 15.26 场景 4：上游组件在协商期间接收 TLP
## 15.27 Scenario 4: Upstream Component Receives TLP | 15.27 场景4：协商期间上游组件接收TLP
...
## 15.28 Scenario 5: Upstream Component Rejects L1 Request | 15.28 场景 5：上游组件拒绝 L1 请求
...
## 15.29 Exit from L1 ASPM State | 15.29 退出 L1 ASPM 状态
...
## 15.30 Software Initiated Link Power Management
...
## 15.31 Entering the L1 State | 15.31 进入L1状态
...
## 15.32 Exiting the L1 State | 15.32 退出 L1 状态
...
## 15.33 L2 | 15.33 L3 Ready — Removing Power from the Link
...
## 15.34 L2 | 15.34 L3 Ready Handshake Sequence
...
## 15.35 The PME Message | 15.35 PME 报文
...
## 15.36 The PME Sequence | 15.36 PME 序列
...
## 15.37 The Problem | 15.37 问题

## 15.38 Problem | 15.38 问题
...
## 15.40 The PME Context | 15.40 PME 上下文
...
## 15.41 PCI Express Technology | 15.41 PCI Express 技术
...
## 15.42 Waking Non-Communicating Links | 15.42 唤醒非通信链路
...
## 15.43 Auxiliary Power | 15.43 辅助电源
...
## 15.46 LTR Registers | 15.46 LTR寄存器
...
## 15.47 LTR Messages | 15.47 LTR 消息
...
## 15.48 Guidelines Regarding LTR Use | 15.48 LTR 使用指南
...
## 15.49 LTR Example | 15.49 LTR 示例
...
## 15.50 Interrupt Support Background | 15.50 中断支持背景

| EN | ZH |
|---|---|
| ## Interrupt Support Background | ## 中断支持背景 |

## 15.51 General | 15.51 概述
...
## 15.52 Two Methods of Interrupt Delivery | 15.52 两种中断投递方式
...
## 15.54 Changes to Support Multiple Processors | 15.54 支持多处理器的变更
...
## 15.55 Legacy PCI Interrupt Delivery | 15.55 传统 PCI 中断传递
