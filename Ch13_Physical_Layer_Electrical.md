...
<table style="border-collapse:collapse; width:100%;">
  ...
  <tbody>
    ...
    <tr><td width="50%" style="border:2px solid #000; background:#fff;padding:4px 8px;">• Logical 1 is signaled with a positive differential voltage.<br>• Logical 0 is signaled with a negative differential voltage.</td><td width="50%" style="border:2px solid #000; background-color:#e8e8e8;padding:4px 8px;">• 逻辑 1 通过正差分电压信号表示。<br>• 逻辑 0 通过负差分电压信号表示。</td></tr>
